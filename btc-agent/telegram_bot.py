...
Uses plain text mode to avoid Markdown parse errors from special characters
like $, +, -, . in prices and P&L figures.
"""
...
def send_message(text: str) -> bool:
    """Send a Telegram message in plain text. Returns True on success."""
...
def send_daily_report(state, performance, daily_review):
    """Format and send the daily P&L report."""
    ...
    pos_text = (
        f"Open position: {pos['side']} @ ${pos['entry_price']:,.2f} "
